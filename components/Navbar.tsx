...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex md:hidden">
            ...
            <button
              ...
              className="ml-2 inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-300 focus:outline-none"
            >
      ...
      {/* Mobile menu */}
      <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden bg-primary border-t border-gray-700`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <div className="text-white font-medium flex items-center px-3 py-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
              <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
            </svg>
